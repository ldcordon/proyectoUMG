<nav class="navbar navbar-default navbar-fixed-top navbar-inverse">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="?view=index">SoftApp</a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <!--  <li class="active"><a href="#">Link <span class="sr-only">(current)</span></a></li>-->
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="?view=person&mode=add">Altas de Personal</a></li>
            <li><a href="#">Bajas de Personal</a></li>
      ...
      <ul class="nav navbar-nav">
       <!--<li class="active "><a href="#">Link <span class="sr-only">(current)</span></a></li>-->
        <!--<li><a class="glyphicon glyphicon-align-justify" href="#"></a></li>-->
        <li class="dropdown">
  ...
  <ul class="dropdown-menu">
    ...
    <li><a href="#">Separated link</a></li>
      ...
      <!--  <li class="dropdown">
        ...
        <li><a data-toggle="modal" data-target="#Registro"><span class="glyphicon glyphicon-user"></span> Sign Up</a></li>
